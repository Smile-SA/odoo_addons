...
====================
Smile Customize Data
====================

This module allows to add new models, fields, menus and wiews in the interface and to export them in a new module which can be integrated in the code.
