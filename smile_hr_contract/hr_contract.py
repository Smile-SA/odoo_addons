...
class HrEmployee(orm.Model):
    ...
    def _get_latest_contract(self, cr, uid, ids, field_name, args, context=None):
        ...
        for employee in self.browse(cr, uid, ids, context=context):
            ...
            contract_ids = contract_obj.search(cr, uid, [('employee_id', '=', employee.id), ('date_start', '<=', today)],
    ...
    def __init__(self, pool, cr):
        super(HrEmployee, self).__init__(pool, cr)
        self._columns['contract_id']._fnct = HrEmployee._get_latest_contract
