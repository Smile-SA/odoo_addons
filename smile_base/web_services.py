...
from openerp.service.web_services import objects_proxy, report_spool
...
objects_proxy.dispatch = smile_detective(config.get('log_service_object', 0.000))(objects_proxy.dispatch)
