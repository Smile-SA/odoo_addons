...
native_check_access_rights = models.BaseModel.check_access_rights
...
def check_access_rights(self, operation, raise_exception=True):
    ...
    return native_check_access_rights(self, operation, raise_exception)


models.BaseModel.check_access_rights = check_access_rights
