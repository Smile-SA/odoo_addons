...
class AccountAssetAsset(orm.Model):
    ...
    _track = {
        'state': {
            'smile_account_asset.mt_asset_confirmation': lambda self, cr, uid, obj, ctx=None: obj.state == 'confirm',
            'smile_account_asset.mt_asset_validation': lambda self, cr, uid, obj, ctx=None: obj.state == 'open',
            'smile_account_asset.mt_asset_sale': lambda self, cr, uid, obj, ctx=None: obj.state == 'close',
        },
    }
