...
2. add one automated action for the target model, add the following python code, this automated action can be applied(when to run) to creation, update or delete per your requirement
