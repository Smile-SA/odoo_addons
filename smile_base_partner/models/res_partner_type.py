...
class ResPartnerType(models.Model):
    ...
    subcompanies_label = fields.Char('Sub-companies label', translate=True, required=True, default='Sub-companies')
    ...
    partner_display_name = fields.Char(default='partner.name_get()[0][1]',
