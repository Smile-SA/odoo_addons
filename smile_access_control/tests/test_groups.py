...
class TestGroups(TransactionCase):
    ...
    def test_write(self):
        ...
        self.assertEqual('Group 1 EDITED', self.group1.name)
        self.assertTrue(
        ...
        self.assertEqual(self.group_completion, self.group1.implied_ids)
        self.assertEqual(self.group_completion, self.group2.implied_ids)
    ...
    def test_button_complete_access_controls(self):
        ...
        expected_list_after_completion = [
            'Models', 'Model Access', 'Fields', 'View', 'User']
